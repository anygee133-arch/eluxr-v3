...
- [x] **PIPE-04**: AI image prompt generation for each post via Claude
- [x] **PIPE-05**: Video script generation (hook/setup/value/CTA structure) via Claude
...
| PIPE-04 | Phase 6: Content Pipeline | Complete |
| PIPE-05 | Phase 6: Content Pipeline | Complete |
